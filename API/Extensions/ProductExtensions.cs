...
namespace API.Extensions
{
    ...
    {
        // by this IQueryable<Product> query we extending method and creating new method
        ...
        public static IQueryable<Product> Search(this IQueryable<Product> query, string searchTerm)
        {
            ...
            var lowerCaseSearchTerm = searchTerm.Trim().ToLower(); //trim removing white spaces
